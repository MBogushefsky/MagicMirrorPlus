...
describe("File js/class", function () {
  describe("Test function cloneObject", function () {
    ...
    it("should clone nested object", function () {
      ...
      expect(expected.properties.items === obj.properties.items).to.equal(
        false
      );
      expect(expected.properties.items[0] === obj.properties.items[0]).to.equal(
        false
      );
      expect(expected.properties.items[1] === obj.properties.items[1]).to.equal(
        false
      );
    });
