  ...
  describe("Current weather", function () {
    ...
    describe("Default configuration", function () {
      ...
      it("should render sunrise", async function () {
        ...
        await app.client.waitForExist(
          ".weather .normal.medium span.wi.dimmed.wi-sunrise",
          10000
        );
      ...
      it("should render sunset", async function () {
        ...
        await app.client.waitForExist(
          ".weather .normal.medium span.wi.dimmed.wi-sunset",
          10000
        );
      ...
      it("should render temperature with icon", async function () {
        ...
        await app.client.waitForExist(
          ".weather .large.light span.wi.weathericon.wi-snow",
          10000
        );

        return app.client.waitUntilTextExists(
          ".weather .large.light span.bright",
          "1.5°",
          10000
        );
      });
      ...
      it("should render feels like temperature", async function () {
        ...
        return app.client.waitUntilTextExists(
          ".weather .normal.medium span.dimmed",
          "Feels like -5.6°",
          10000
        );
      });
    ...
    describe("Configuration Options", function () {
      ...
      it("should render showWindDirectionAsArrow = true", async function () {
        ...
        await app.client.waitForExist(
          ".weather .normal.medium sup i.fa-long-arrow-up",
          10000
        );
        const element = await app.client.getHTML(
          ".weather .normal.medium sup i.fa-long-arrow-up"
        );
      ...
      it("should render showHumidity = true", async function () {
        ...
        await app.client.waitUntilTextExists(
          ".weather .normal.medium span:nth-child(3)",
          "93",
          10000
        );
        return app.client.waitForExist(
          ".weather .normal.medium sup i.wi-humidity",
          10000
        );
      });
    ...
    describe("Default configuration", function () {
      ...
      it("should render icons", async function () {
        ...
        for (const [index, icon] of icons.entries()) {
          await app.client.waitForExist(
            `.weather table.small tr:nth-child(${
              index + 1
            }) td:nth-child(2) span.wi-${icon}`,
            10000
          );
        }
      });
      ...
      it("should render fading of rows", async function () {
        ...
        for (const [index, opacity] of opacities.entries()) {
          const html = await app.client.getHTML(
    ...
    describe("Configuration Options", function () {
      ...
      it("should render colored rows", async function () {
        ...
        const rows = await app.client.$$(
          ".weather table.myTableClass tr.colored"
        );
