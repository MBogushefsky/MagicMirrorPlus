...
Module.register("alert", {
  ...
  show_notification: function (message) {
    ...
    new NotificationFx({
      ...
      ttl:
        message.timer !== undefined ? message.timer : this.config.display_time,
    }).show();
  },
  show_alert: function (params, sender) {
    ...
    if (
      ...
      typeof params.imageFA === "undefined"
    ) {
      ...
      image =
        ...
        "fa fa-" +
        params.imageFA +
        "' style='margin-bottom: 10px;font-size:" +
        params.imageHeight.toString() +
        ";'/></span><br />";
    }
    //Create overlay
    ...
    if (params.title) {
      message +=
        "<span class='light dimmed medium'>" + params.title + "</span>";
    }
    if (params.message) {
      if (message !== "") {
        message += "<br />";
      ...
      message +=
        "<span class='thin bright small'>" + params.message + "</span>";
    }
